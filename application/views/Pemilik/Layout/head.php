...
<head>
	...
	<title>SURYA TOSERBA CILEDUG</title>
	<!-- plugins:css -->
	...
	<link rel="stylesheet" href="<?= base_url('asset/admin/template/') ?>vendors/datatables.net-bs4/dataTables.bootstrap4.css">
	<link rel="stylesheet" href="<?= base_url('asset/admin/template/') ?>js/select.dataTables.min.css">
